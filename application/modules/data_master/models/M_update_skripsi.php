 ...
 * 
 */
class M_update_skripsi extends CI_Model {
	...
	function get_data_sempro($res_prodi) {
		...
		$this->datatables->select('
			...
			b.submission_code
			');
		$this->datatables->from('bimbingan_skripsi b');
	...
	function updatejudulskripsi($id, $submission_code, $nim, $jdlskrip, $upd){
	...
	function updatejudulskripsi2($id, $submission_code, $pembimbbar, $nim, $jdlskrip, $upd){
		$query 		= " UPDATE bimbingan_skripsi 
								SET title = '$jdlskrip',
								dosbing = '$pembimbbar',
								upd = '$upd'
