<script type="text/javascript">
	...
	$("#tableMappingHafalan").DataTable({
		...
		// lengthChange: false,
		ajax: {
			url: baseURL + "mapping/mapping_hafalan_qq/list_data",
			type: "POST",
			data: function(d){
	...
	$('#tableMappingHafalan').on('click', '.btn-edit', function(){
		...
		$('#id').val(id);
		$('#nim').val(nim);
		$('#kiraatul_quran').val(kiraatul_quran);
		$('#nip').val(nip);
		$('#modalMappingHafalan').modal('show');
	});
	...
	$('#form-editMappingHafalan').submit(function(e){
		...
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_qq/save',
			type: 'POST',
			data: $(this).serialize(),
			dataType: 'JSON',
	...
	$('#form-uploadMappingHafalan').submit(function(e){
		...
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_qq/uploads',
			type: 'POST',
	...
	function deleteMappingHafalan(id,mhs){
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_qq/delete',
			type: 'POST',
			data: {
