<script type="text/javascript">
	...
	$('#form-search-report').on('submit', function(e) {
		...
		$('#card-mapping-hadist').hide();
		$('#card-loading').fadeIn();

		var table = $("#tableMappingHafalan").DataTable();
		table.ajax.reload(function(){
			$('#card-loading').hide();
			$('#card-mapping-hadist').fadeIn();
		});
	});
	...
	$("#tableMappingHafalan").DataTable({
		...
		// lengthChange: false,
		ajax: {
			url: baseURL + "mapping/mapping_hafalan_hadist/list_data",
			type: "POST",
			data: function(d){
	...
	$('#form-editMappingHafalan').submit(function(e){
		...
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_hadist/save',
			type: 'POST',
			data: $(this).serialize(),
			dataType: 'JSON',
	...
	$('#form-uploadMappingHafalan').submit(function(e){
		...
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_hadist/uploads',
			type: 'POST',
	...
	function deleteMappingHafalan(id,mhs){
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_hadist/delete',
			type: 'POST',
			data: {
