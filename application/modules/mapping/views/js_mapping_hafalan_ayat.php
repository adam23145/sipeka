<script type="text/javascript">
	...
	$('#form-search-report').on('submit', function(e) {
		...
		$('#card-mapping-ayat').hide();
		$('#card-loading').fadeIn();

		var table = $("#tableMappingHafalan").DataTable();
		table.ajax.reload(function(){
			$('#card-loading').hide();
			$('#card-mapping-ayat').fadeIn();
		});
	});
	...
	var table = $("#tableMappingHafalan").DataTable({
		...
		// lengthChange: false,
		ajax: {
			url: baseURL + "mapping/mapping_hafalan_ayat/list_data",
			type: "POST",
			data: function(d){
	...
	$('#form-editMappingHafalan').submit(function(e){
		...
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_ayat/save',
			type: 'POST',
			data: $(this).serialize(),
			dataType: 'JSON',
	...
	$('#form-uploadMappingHafalan').submit(function(e){
		...
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_ayat/uploads',
			type: 'POST',
	...
	function deleteMappingHafalan(id,mhs){
		$.ajax({
			url: baseURL + 'mapping/mapping_hafalan_ayat/delete',
			type: 'POST',
			data: {
