        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Mapping Hafalan Ayat</h3>
                ...
                <div id="card-mapping-ayat" class="card card-primary card-outline">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form id="form-editMappingHafalan" method="POST">
                                            ...
                                            <div class="modal-body">
												...
												<fieldset class="form-group floating-label-form-group">
                                                    <label for="title">Ayat</label>
                                                    <select class="custom-select d-block w-100" name="ayat" id="ayat" required="">
                                                        <option value="">-- Select Ayat --</option>
                                                        {data_ayat}
                                                        <option value="{id}">{ayat}</option>
                                                        {/data_ayat}
                                                    </select>
                                                </fieldset>
                                                <fieldset class="form-group floating-label-form-group">
							...
							<div class="modal-content">
								...
								<form id="form-uploadMappingHafalan" method="POST" enctype="multipart/form-data">
									...
									<div class="modal-footer justify-content-between">
										<div>
											<a href="../document/files/Template-Mapping-Ayat.xlsx" target="_blank" style="float: right;" class="btn btn-tool bg-gradient-primary btn-sm" >
