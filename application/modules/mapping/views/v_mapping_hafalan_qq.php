        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Mapping Hafalan Kiraatul Qur`an</h3>
                ...
                <div id="card-mapping-qq" class="card card-primary card-outline">
						...
						<table id="tableMappingHafalan" class="table table-bordered table-striped">
							<thead>
								<tr>
									<th>No</th>
									<th>id</th>
									<th>kiraatul_quran</th>
									<th>NIM</th>
									<th>Nama Mahasiswa</th>
									<th>Prodi</th>
									<th>Nama Mahasiswa</th>
									<th>Kiraatul Qur`an</th>
									<th>Tema Kiraatul Qur`an</th>
									<th>NIP</th>
									<th>Nama Dosen</th>
									<th>Action</th>
								</tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form id="form-editMappingHafalan" method="POST">
                                            ...
                                            <div class="modal-body">
												...
												<fieldset class="form-group floating-label-form-group">
                                                    <label for="title">Kiraatul Qur`an</label>
                                                    <select class="custom-select d-block w-100" name="kiraatul_quran" id="kiraatul_quran" required="">
                                                        <option value="">-- Select Kiraatul Qur`an --</option>
                                                        {data_qq}
							...
							<div class="modal-content">
								...
								<form id="form-uploadMappingHafalan" method="POST" enctype="multipart/form-data">
									...
									<div class="modal-footer justify-content-between">
										<div>
											<a href="../document/files/Template-Mapping-KiraatulQuran.xlsx" target="_blank" style="float: right;" class="btn btn-tool bg-gradient-primary btn-sm" >
