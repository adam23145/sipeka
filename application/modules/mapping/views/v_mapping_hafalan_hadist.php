        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Mapping Hafalan Hadist</h3>
				...
				<div id="card-mapping-hadist" class="card card-primary card-outline">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form id="form-editMappingHafalan" method="POST">
                                            ...
                                            <div class="modal-body">
												...
												<fieldset class="form-group floating-label-form-group">
                                                    <label for="title">Hadist</label>
                                                    <select class="custom-select d-block w-100" name="hadist" id="hadist" required="">
                                                        <option value="">-- Select Tema Hadist --</option>
                                                        {data_hadist}
							...
							<div class="modal-content">
								...
								<form id="form-uploadMappingHafalan" method="POST" enctype="multipart/form-data">
									...
									<div class="modal-footer justify-content-between">
										<div>
											<a href="../document/files/Template-Mapping-Hadist.xlsx" target="_blank" style="float: right;" class="btn btn-tool bg-gradient-primary btn-sm" >
