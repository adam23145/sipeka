...
class NewPublikasi extends CI_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model('M_newpublikasi');
	...
	function index()
    {
        ...
        $data = array(
            'thisContent'     => 'publikasi/v_new_publikasi',
            'thisJs'        => 'publikasi/js_new_publikasi',
        );
	...
	function get_data()
	{
		...
		$list = $this->M_newpublikasi->get_all($limit, $start, $search, $status,$username);
		$totalData = $this->M_newpublikasi->count_all($username);
		$totalFiltered = $this->M_newpublikasi->count_filtered($search, $status,$username);
	...
	public function update_status()
	{
		...
		$update = $this->M_newpublikasi->update_status($id, $data_update);
