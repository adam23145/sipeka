        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                <div class="mt-3">
                    ...
                    <input type="text" id="judulRevisi" class="form-control" value="${data.data.mbkm || ''}">
                </div>
    ...
    $(document).on('click', '#saveRevisi', function() {
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                console.log('Response Text:', jqXHR.responseText); // Tambahkan ini untuk melihat respons asli
                swal("Kesalahan!", "Terjadi kesalahan saat mengirim data: " + jqXHR.responseText, "error");
            }
        });
    });
</script>