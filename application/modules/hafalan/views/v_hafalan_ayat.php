        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title" style="margin-top: 5px;">Hafalan Ayat</h3>
					<?php
						if($level == "mahasiswa"){
							?>
					...
					<div class="modal-dialog modal-xl" role="document">
						<div class="modal-content">
							<div class="modal-header">
							  <h5 class="modal-title" id="myModalLabel35"> Hafalan Ayat </h5>
							...
							<form id="form-inputLink" method="POST">
								...
								<div class="modal-body">
									...
									<input type="hidden" class="form-control" id="mapping_ayat" name="mapping_ayat" value="0">
									<div class="row">
										<div class="col-lg-4">
											<div class="card card-primary card-outline">
												<div class="card-header">
													<h1 id="ayat" name="ayat" class="card-title">Hafalan Ayat</h1>
												</div>
												<div class="card-body">
													<h3 id="tema" name="tema">Hafalan Ayat</h3>
												</div>
											</div>
										</div>
										<div class="col-lg-8">
											<div class="card card-primary card-outline">
												<div class="card-header">
													<h3 class="card-title">Upload Hafalan Ayat</h3>
												</div>
												<div class="card-body">
						...
						<div class="modal-content">
							...
							<form id="form-inputNilai" method="POST">
								<div class="modal-body">
									...
									<input type="hidden" class="form-control" id="mapping_ayatForDosen" name="mapping_ayatForDosen" value="0">
									<div class="row">
										<div class="col-lg-4">
											<div class="card card-primary card-outline">
												<div class="card-header">
													<h1 id="ayatForDosen" name="ayatForDosen" class="card-title">Penilaian Hafalan Ayat</h1>
												</div>
												<div class="card-body">
													<h3 id="temaForDosen" name="temaForDosen">Penilaian Hafalan Ayat</h3>
												</div>
											</div>
										</div>
										<div class="col-lg-8">
											<div class="card card-primary card-outline">
												<div class="card-header">
													<h3 class="card-title">Penilaian Hafalan Ayat</h3>
												</div>
												<div class="card-body">
													<fieldset class="form-group floating-label-form-group">
