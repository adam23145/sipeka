<script type="text/javascript">
	...
	$('#table-dokumen').on('click', '.btn-view', function() {
		...
		} else if (dokumen === 'File Berita Acara Sempro') {
			control = 'data_pdf/pdf006?subcd=';
		} else if (dokumen === 'File Seminar Proposal' || dokumen === 'File Seminar Proposal ' || dokumen === ' File Seminar Proposal ' || dokumen === ' File Seminar Proposal') {
