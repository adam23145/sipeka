        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Master Data Kiraatul Kutub</h3>
				...
				<div id="card-table-KK" class="card card-primary card-outline">
                ...
                <div class="form-group">
                            <div class="modal fade text-left" id="modalKK" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
                    aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="myModalLabel35"> Add Kiraatul Kutub</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                        <form id="form-editKK" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <fieldset class="form-group floating-label-form-group">
                                                    <label for="email">Kiraatul Kutub</label>
                                                    <input type="text" class="form-control" name="kk" id="kk" name="" placeholder="Kiraatul Kutub" required="">
                                                </fieldset>
                                                <fieldset class="form-group floating-label-form-group">
				...
				<div class="form-group">
					<div class="modal fade text-left" id="modalUpload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
								  <h5 class="modal-title" id="myModalLabel35"> Upload Kiraatul Kutub</h5>
								  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								  </button>
								</div>
								<form id="form-uploadKK" method="POST" enctype="multipart/form-data">
									<input required type="text" readonly hidden name="token" id="token" value="<?php echo $this->security->get_csrf_hash(); ?>">
									<div class="modal-body">
										<fieldset class="form-group floating-label-form-group">
									...
									<div class="modal-footer justify-content-between">
										<div>
											<a href="../document/files/Template-kiraatulkutub.xlsx" target="_blank" style="float: right;" class="btn btn-tool bg-gradient-primary btn-sm" >
