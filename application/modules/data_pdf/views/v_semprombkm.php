...
<head>
    ...
    <title>Form Persetujuan Dosen Pembimbing MBKM</title>
    <style>
        @page {
            size: A4;
        }
    ...
    <table width="100%">
        <tr>
            <td align="center">
                ...
                <span style="font-weight: bold">KESEDIAAN MENJADI DOSEN PEMBIMBING MBKM</span>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td>Untuk menjadi <b>dosen pembimbing MBKM</b></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
