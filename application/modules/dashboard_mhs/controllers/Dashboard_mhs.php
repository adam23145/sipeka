...
class Dashboard_mhs extends CI_Controller
{
	...
	function index()
	{
		...
		$mbkm_count = $this->M_dashboard->count_mbkm($nim);
		$status_pengajuan = $this->M_dashboard->get_status_pengajuan_judul($nim);
		$status_pengajuan = !empty($status_pengajuan)
			? ($status_pengajuan->status_pengajuan_judul === 'Menunggu'
				? "Menunggu Konfirmasi " . $status_pengajuan->posisi_berkas
				: $status_pengajuan->status_pengajuan_judul)
			: "Belum Ada Pengajuan";
