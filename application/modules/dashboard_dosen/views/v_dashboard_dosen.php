<div class="row">
  <div class="col-lg-4">
    <div class="small-box bg-warning">
      ...
      <a href="<?php echo base_url(); ?>bimbingan/bimbingan" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-primary">
      ...
      <a href="<?php echo base_url(); ?>bimbingan/bimbingan_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-success">
      ...
      <a href="<?php echo base_url(); ?>bimbingan/list_sempro" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
</div>
<div class="row">
  <div class="col-lg-4">
    <div class="small-box bg-warning">
      <div class="inner">
        <h3>{bskripsinew}</h3>
        <p>Permintaan Bimbingan Skripsi</p>
      </div>
      <div class="icon">
        <i class="ion ion-person-add"></i>
      </div>
      <a href="<?php echo base_url(); ?>skripsi/bimbingan" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-primary">
      ...
      <a href="<?php echo base_url(); ?>skripsi/bimbingan_list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-success">
      ...
      <a href="<?php echo base_url(); ?>skripsi/histori_bimbingan_skripsi" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
</div>
<div class="row">
  <div class="col-lg-4">
    <div class="small-box bg-warning">
      ...
      <a href="<?php echo base_url(); ?>mbkm/Mbkmsempro_new" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-primary">
      ...
      <a href="<?php echo base_url(); ?>mbkm/Mbkmsempro" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-success">
      ...
      <a href="<?php echo base_url(); ?>mbkm/Mbkmsempro_done" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
</div>
<div class="row">
  <div class="col-lg-4">
    <div class="small-box bg-warning">
      ...
      <a href="<?php echo base_url(); ?>mbkm/Mbkmskripsi_new" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-primary">
      ...
      <a href="<?php echo base_url(); ?>mbkm/Mbkmskripsi" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="small-box bg-success">
      ...
      <a href="<?php echo base_url(); ?>mbkm/Mbkmskripsi_done" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
  </div>
</div>
<div class="row">
