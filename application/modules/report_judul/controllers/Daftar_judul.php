...
class Daftar_judul extends CI_Controller {
	...
	function index() {
		...
		$this->breadcrumb->add('Report Judul','report_judul/daftar_judul')
		->add('Daftar Judul','report_judul/daftar_judul');
		$jurusan = $this->M_global->get_prodi();
		$data = array(
			'thisContent' 	=> 'report_judul/v_daftar_judul',
			'thisJs'		=> 'report_judul/js_daftar_judul',
			'jurusan'		=> $jurusan
		);
