			...
			<div class="container-login100"> 
				<div class="wrap-login100">
					<form class="login100-form" id="loginform" method="POST">
						...
						<div class="row">
							<div class="input-field col s12 center">
								...
								<h1 style="font-size: 26px;font-weight: bold;" class="center login-form-text">I'M SORRY</h1>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12 center">
								<!--img src="<?php echo base_url();?>public/assets/core/images/logo1.png" alt="" class="responsive-img valign profile-image-login" -->
								<h5 class="center login-form-text"><img src="<?php echo base_url();?>public/assets/core/images/perbaikan.png" width="390" height="250"></h5>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12 center">
								<!--img src="<?php echo base_url();?>public/assets/core/images/logo1.png" alt="" class="responsive-img valign profile-image-login" -->
								<h5 class="center login-form-text">Our website is currently undergoing scheduled maintenance. We Should be back shortly.<br> Thank you for your patience.</h5>
							</div>
						</div>
					...
					<div class="login100-more"  >
						<img class="responsive" src="<?php echo base_url();?>public/assets/core/images/misi.jpg" alt="" class="responsive-img valign profile-image-login">
					</div>
				</div>      
			</div>      
		</div>
